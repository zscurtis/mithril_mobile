const CACHE_NAME = "mithril-mobile-m39-6-2-keyboard-focus-event-repair-v1";
const APP_SHELL = [
  "./",
  "./index.html",
  "./shot_diagram_m38.html",
  "./shot_diagram_m34.html",
  "./mithril-menu-m3962.js",
  "./mithril-update.js",
...
function patchHTMLResponse(response, requestUrl) {
  ...
  return response.text().then(html => {
    // Version labels are updated safely at runtime by mithril-menu-m3962.js.
    ...
    const scriptTag = '<script src="./mithril-menu-m3962.js?v=39.6.2"></script>';
