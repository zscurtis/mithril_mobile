const CACHE_NAME = "mithril-mobile-m40-9-6-9-5-jobs-permission-path-fix-v1";
const APP_SHELL = [
  "./",
  "./index.html",
  "./shot_diagram_m38.html",
  "./shot_diagram_m34.html?v=40.9.6.9.5",
  "./mithril-menu-m397.js",
  "./mithril-core-m400.js",
  "./mithril-company-cloud-m40969.js",
  "./mithril-pending-home-hotfix-m409693.js",
  "./mithril-jobs-m410.js?v=40.9.6.9.5",
  "./mithril-update.js",
...
function patchCoreResponse(response) {
  ...
  return response.text().then(source => {
    let patched = source
      .replace('var RELEASE_VERSION = "m40.9.6.8";', 'var RELEASE_VERSION = "m40.9.6.9.5";')
      .replace('var RELEASE_VERSION = "m40.9.6.9.3";', 'var RELEASE_VERSION = "m40.9.6.9.5";')
      .replace('var CHILD_SCRIPT_SRC = "./mithril-core-m400.js?rev=40966-frame";', 'var CHILD_SCRIPT_SRC = "./mithril-core-m400.js?rev=409695-frame";')
      .replace('var CHILD_SCRIPT_SRC = "./mithril-core-m400.js?rev=409693-frame";', 'var CHILD_SCRIPT_SRC = "./mithril-core-m400.js?rev=409695-frame";')
      .replace(
...
function patchHTMLResponse(response, requestUrl) {
  ...
  return response.text().then(html => {
    ...
    const scriptTags = [
      '<script src="./mithril-menu-m397.js?v=40.9.6.9.5"></script>',
      '<script src="./mithril-core-m400.js?v=40.9.6.9.5"></script>',
      '<script src="./mithril-company-cloud-m40969.js?v=40.9.6.9.5"></script>',
      '<script src="./mithril-pending-home-hotfix-m409693.js?v=40.9.6.9.5"></script>',
      '<script src="./mithril-jobs-m410.js?v=40.9.6.9.5"></script>'
    ].join("");
