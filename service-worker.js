const CACHE_NAME = "mithril-mobile-m40-9-6-8-ipad-keypad-v1";
const APP_SHELL = [
  "./",
  "./index.html",
  "./shot_diagram_m38.html",
  "./shot_diagram_m34.html?v=40.9.6.8",
...
function patchHTMLResponse(response, requestUrl) {
  ...
  return response.text().then(html => {
    ...
    const scriptTags = [
      '<script src="./mithril-menu-m397.js?v=40.9.6.8"></script>',
      '<script src="./mithril-core-m400.js?v=40.9.6.8"></script>'
    ].join("");
