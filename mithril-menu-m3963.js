(function () {
  ...
  var RELEASE_VERSION = "m39.6.3";
  var RELEASE_LABEL = "Shot Diagram frame-loader repair for Physical Keyboard mode, direct number-row and numpad capture, Tab field navigation, Enter Save + Next, keyboard guidance, dual shot volumes, pattern calculations, closable PDF preview, explosive-load extremes, selection tools, GPS callouts, and structured hole conditions";
  ...
  function installShotFrameBridge() {
    ...
    function injectChildScript() {
      try {
        ...
        script.src = "./mithril-menu-m3963.js?v=39.6.3-frame";
