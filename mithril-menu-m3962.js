(function () {
  ...
  var RELEASE_VERSION = "m39.6.2";
  var RELEASE_LABEL = "Physical keyboard focus and event repair for Shot Diagram and Drill Log, direct number-row and numpad capture, Tab field navigation, Enter Save + Next, keyboard guidance, dual shot volumes, pattern calculations, closable PDF preview, explosive-load extremes, selection tools, GPS callouts, and structured hole conditions";
  ...
  // ---------------------------------------------------------------------------
  // m39.6.2 physical keyboard and numpad entry
  // ---------------------------------------------------------------------------
