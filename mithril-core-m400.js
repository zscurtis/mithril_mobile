(function () {
  ...
  var CHILD_SCRIPT_SRC = "./mithril-core-m400.js?rev=40921-frame";
  ...
  function injectIntoShotFrame() {
    ...
    function inject() {
      ...
      } catch (error) { console.warn("MITHRIL m40.9.2.1 could not attach the standardized document layer to the Shot Diagram.", error); }
    }
