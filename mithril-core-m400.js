(function () {
  ...
  function ensureTransferModal() {
    ...
    modal.innerHTML = [
      '<div class="m400Box">',
      '<div class="m400Head"><strong>Create Shot Diagram from Drill Log - m40.9.6</strong><button type="button" id="m400TransferClose">Close</button></div>',
  ...
  function injectIntoShotFrame() {
    ...
    function inject() {
      ...
      } catch (error) { console.warn("MITHRIL m40.9.6 could not attach the document layer to the Shot Diagram.", error); }
    }
